...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    ...
    '프론트엔드외 다양한 기술 분야에도 호기심이 많아, 기술 이해도를 높이기 위해 꾸준히 학습하고 있습니다. 프로젝트 분석과 문제 해결은 사용하는 기술에 대한 깊은 이해에서 시작된다고 믿으며, 현재 진행 중인 프로젝트의 기획과 기능에 대한 필요성을 파악하기 위해 OpenStack 기술 개념을 학습했으며 실제 데이터에 대해 더 자세하게 접근하고 싶어 SQL 학습을 병행하고 있습니다.',
